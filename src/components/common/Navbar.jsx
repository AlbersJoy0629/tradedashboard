    ...
    return (
        <div className={"w-full h-[80px] px-[30px] py-[10px] flex items-center justify-between bg-lightPrimaryColor dark:bg-darkPrimaryColor sm:justify-between"}>
            <div className="hidden gap-7 sm:flex">
                ...
                onClick={() => window.open(account.tradeSystem=="LaserTrade" ? 'http://localhost:3001/' : 'https://www.metatrader4.com/en', '_blank')}
                disabled={account?.tradeSystem != "LaserTrade" && account?.tradeSystem != "MT4"}
                >
                    Founded
                    </button>
            </div>
